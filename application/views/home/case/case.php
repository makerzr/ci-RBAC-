...
<main>
    ...
    <?php foreach($list as $k=>$v){?>
        <li>
            <a href="<?php echo site_url('home/Product/content/?id=').$v['case_id'];?>">
            <img src="../../public/uploads/<?php echo $v['case_img']?>" alt="" style="width:255px;height:200px">
            <div class="pro-rightarea">
                <p><?php echo $v['case_title']?></p>
                <span><?php echo mb_substr($v['case_content'],0,150).'...'?></span>
            </div>
            </a>
        </li>
        <br>
        <?php }?>
         ...
         <div class="article_list_more_pages"><?php echo $this->pagination->create_links();?></div>
