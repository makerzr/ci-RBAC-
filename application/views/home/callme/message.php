...
<div class="message-form">
   <form method="post" action="<?php echo site_url('home/Message/msginsert')?>">
       <ul>
           <li><span>注:<i>*</i>号为必填哦</span></li>
           <li><label for="username">姓名</label><input type="text" id="username" name="message_name"><i>*</i></li>
           <li><label for="tel">电话</label><input type="text" id="tel" name="message_phone"><i>*</i></li>
           <li><label for="email">邮箱</label><input type="text" id="email" name="message_email"><i>*</i></li>
           <li><label for="content">内容</label><textarea id="content" name="message_content"></textarea><i>*</i></li>
           <li><button type="submit" class="am-btn am-btn-danger">提交</button><span>注:<i>*</i>号为必填哦</span></li>
       </ul>
   </form>
</div>
</div>
