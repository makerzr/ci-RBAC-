...
<div>
    <section class="article-content">
        ...
        <?php foreach($cates as $k=>$v){?>
            <span><a href="<?php echo site_url('home/News/catelist/?id=').$v['cate_id'];?>"><?php echo $v['cate_name']?></a></span>
            <?php }?>
        </div>
        <div class="article-protect-body">
           <?php foreach($img as $k=>$v){?>
            <img src="../../public/uploads/<?php echo $v['news_img']?>" style="width:400px;height:320px;">
            <?php }?>
            <ul>
