...
<main>
    ...
    <div class="index-main-md">
        ...
        <div class="right-area">
            <p>保护环境是我们每个人的责任</p>
            <span>XXX环保设备公司是一家专业从事环境污染治理和生态环境修复，集技术开发、技术服务、环保设备制造、工程总承包、资源综合利用的环保公司，主要产品以治理工业废气、、废水处理、固体废物、土壤修复为主，我公司产品有：净化设备，废气净化设备，酸废气净化器，有机废气净化器，干式废气净化 设备，湿式废气净化设备等。还生产噪声治理，暖通设备及电镀槽、水槽及排风净化设备、送风设备等。我公司生产的WGF-3型复合吸附剂治理酸废气净化器及DBS吸附剂荣获国家环保局最佳使用技术型奖。</span>
    ...
    <div class="index-main-md-body">
        ...
        <?php foreach($list as $k=>$v){?>
            <li>
                <p><img src="../../public/uploads/<?php echo $v['team_img']?>" alt="" style="width:290px;height:230px;"></p>
                <p><?php echo $v['team_name']?></p>
                <p><?php echo $v['team_position']?></p><span><?php echo $v['team_manifo']?></span>
            </li>
            <?php }?>
        </ul>
